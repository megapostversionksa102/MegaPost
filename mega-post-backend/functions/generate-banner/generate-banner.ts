                                            ...
                                            style: { width: "35%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
                                                {
                                                    type: "div", props: {
                                                        style: { display: "flex", alignItems: "baseline" }, children: [
                                                            ...
                                                            { type: "span", props: { style: { fontSize: "30px", color: "#64748B", marginLeft: "8px", fontWeight: "bold" }, children: "SAR" } }
                                                        ]
                                                    }
                                                },
                                    ...
                                    children: [
                                        {
                                            type: "div", props: {
                                                style: { display: "flex", alignItems: "baseline", flexDirection: "row" }, children: [
                                                    ...
                                                    { type: "span", props: { style: { fontSize: "30px", color: "#2d3436", fontWeight: "bold", marginLeft: "10px" }, children: "SAR" } }
                                                ]
                                            }
                                        },
                                    ...
                                    children: [
                                        {
                                            type: "div", props: {
                                                ...
                                                children: [
                                                    ...
                                                    { type: "span", props: { style: { fontSize: "30px", marginLeft: "8px", color: "#888", fontWeight: "bold" }, children: "SAR" } }
                                                ]
                                            }
                                        },
